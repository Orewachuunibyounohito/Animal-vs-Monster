...
{
    private const string ITEM_SETTINGS_PATH = "SomePractice/DefaultItemSO/DefaultItemSettings";

    private static Dictionary<ItemName, Item> itemDictionary;

    static ItemFactory(){
        var itemSettings = Resources.Load<ItemSettingsSO>(ITEM_SETTINGS_PATH);
